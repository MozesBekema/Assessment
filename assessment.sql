...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 27 jan 2017 om 09:54
...
(3, 2, 'BKM', 'bekema', 'thomasbekema@gmail.com', 'Thomas Bekema'),
(4, 2, 'JDL', 'joostjoost', 'post@joostdelange.nl', 'Joost de Lange'),
(5, 1, 'admin', 'password', '515547@student.glu.nl', 'admin admin'),
(6, 2, 'GRO', 'guido', 'gromein@glu.nl', 'Guido Romeijn');
...
CREATE TABLE `beoordeling` (
  `acounts_id` int(11) NOT NULL,
  `leerlingen_id` int(11) NOT NULL,
...
INSERT INTO `beoordeling` (`acounts_id`, `leerlingen_id`, `klas_id`, `id`, `wp_id`, `tijd`, `beoordeling`) VALUES
(6, 5, 2, 70, 1, '2017-01-25 09:53:52', 1),
(6, 5, 2, 71, 2, '2017-01-25 09:53:52', 4),
(6, 5, 2, 72, 3, '2017-01-25 09:53:52', 2),
(6, 5, 2, 73, 4, '2017-01-25 09:53:52', 3),
(6, 5, 2, 74, 5, '2017-01-25 09:53:52', 4),
(6, 4, 2, 75, 2, '2017-01-27 07:55:29', 1),
(6, 4, 2, 76, 4, '2017-01-27 07:55:29', 3),
(6, 4, 2, 77, 5, '2017-01-27 07:55:29', 5);
...
(25, 4, '4.5'),
(26, 4, '4.6'),
(1, 1, 'Adviseren opdrachtgever'),
(7, 2, 'Begeleidt uitbesteding aan derden'),
(6, 2, 'Bereid de realisatie voor'),
(3, 1, 'Concept Ontwikkelen'),
(4, 1, 'Een ontwerp maken'),
(10, 2, 'Houd het archief bij'),
(9, 2, 'Levert de media uiting op'),
(8, 2, 'Maakt de mediauiting'),
(2, 1, 'Planning maken'),
(5, 1, 'Presenteren van een ontwerp');
...
ALTER TABLE `beoordeling`
  ADD PRIMARY KEY (`id`,`acounts_id`,`wp_id`);
